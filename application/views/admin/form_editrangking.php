                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url()."index.php/admin/bobot/do_insert"; ?>">
                      ...
                      <span class="section">Personal Info</span>
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nilai Normalisasi<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="nilai_normalisasi" value="<?php echo $id_alternatif; ?>" required="required" type="text">
                        </div>
                      </div> 
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nilai Normalisasi<span class="required">*</span>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="nilai_normalisasi" value="<?php echo $nilai_normalisasi; ?>" required="required" type="text">
                        </div>
                      </div> 
