            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url()."index.php/admin/usulan/do_update"; ?>">
                      ...
                      <span class="section">Personal Info</span>
					   <div class="item form-group">
                        ...
                        <input type="number" id="number" name="id_usulan" required="required"  class="form-control col-md-7 col-xs-12" value="<?php echo $id_usulan; ?>" readonly>
                        </div>
                      </div>
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">HAL<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="hal" required="required" type="text" value="<?php echo $hal; ?>">
                        </div>
                      </div>
					   <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="nama" required="required" type="text" value="<?php echo $nama; ?>">
                        </div>
                      </div>
					   <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">JASA LAYANAN<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="jasalayanan" required="required" type="text" value="<?php echo $jasalayanan; ?>">
                        </div>
                      </div>
					    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="jumlah" required="required" type="text" value="<?php echo $jumlah; ?>">
                        </div>
                      </div>
					   <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">JENIS USULAN</label>
								<div class="col-md-7 col-xs-12" >
								<?php 
								$dd_jenisusulan = 'class="form-control" ';
								echo form_dropdown('id_jenisusulan', $jenisusulan, $jenisusulan_selected, $dd_jenisusulan);
								?>	
								</div>
						 </div>
					  <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">KATEGORI</label>
								<div class="col-md-7 col-xs-12" >
								<?php 
								$dd_kategori = 'class="form-control" ';
								echo form_dropdown('id_kategori', $kategori, $kategori_selected, $dd_kategori);
								?>	
								</div>
						 </div>
						   <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">PEJABAT PENGADAAN</label>
								<div class="col-md-7 col-xs-12" >
								<?php 
								$dd_pejabatpengadaan = 'class="form-control" ';
								echo form_dropdown('id_pejabatpengadaan', $pejabatpengadaan, $pejabatpengadaan_selected, $dd_pejabatpengadaan);
								?>	
								</div>
						 </div>
