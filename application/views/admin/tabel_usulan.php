                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
					  ...
					  <tr>
					  <td><?php echo $d->id_usulan; ?> </td>
					  <td><?php echo $d->hal; ?></td>
					  <td><?php echo $d->nama; ?></td>
					  <td><?php echo $d->jasalayanan; ?></td>
					  <td><?php echo $d->jumlah; ?></td>
					  <td><?php echo $d->tanggal; ?></td>
					  <td><?php echo $d->nama_jenisusulan; ?></td>
					  <td><?php echo $d->nama_kategori; ?></td>
					  <td><?php echo $d->nama_pejabatpengadaan; ?></td>
					  <td align="center">
					   <a href="<?php echo base_url()."index.php/admin/printusulan/edit_data/".$d->id_usulan; ?>"><button class="btn btn-default"><i class="fa fa-print"></i>Print</button></a>
					  <a href="<?php echo base_url()."index.php/admin/usulan/edit_data/".$d->id_usulan; ?>"><button class="btn">Edit</button></a> 
					  <a href="<?php echo base_url()."index.php/admin/usulan/do_delete/".$d->id_usulan; ?>"><button class="btn btn-primary waves-effect">Delete</button></a>
					  </tr>
					  <?php } ?>
                    </table>
                  </div>
				  <a href="<?php echo base_url()."index.php/admin/usulan/add_data"; ?>"><button class="btn btn-success">Tambah data</button></a>
                </div>
              </div>
        <!-- /page content -->
