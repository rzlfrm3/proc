                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url()."index.php/admin/bobot/do_insert"; ?>">
					  ...
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">NAMA BOBOT<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="nama_bobot" required="required" type="text" >
                        </div>
                      </div> 
					  ...
					  <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">KRITERIA</label>
								...
								<?php 
								$dd_kriteria = 'class="form-control" ';
								echo form_dropdown('id_kriteria', $kriteria, $kriteria_selected, $dd_kriteria);
								?>	
								</div>
						 </div>
						  <div class="form-group">
