            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url()."index.php/admin/pegawai/do_update"; ?>">
                      ...
                      <div class="item form-group">
                        ...
                        <input type="number" id="number" name="nip" required="required"  class="form-control col-md-7 col-xs-12" value="<?php echo $nip; ?>" readonly>
                        </div>
                      </div>
					  <div class="item form-group">
					   ...
					   <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="email" required="required" type="text" value="<?php echo $email; ?>">
                        </div>
                      </div>
					   <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="password" required="required" type="text" value="<?php echo $password; ?>">
                        </div>
                      </div>
					  <div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12">SUB BIDANG</label>
							...
							<?php 
							$dd_subbidang = 'class="form-control" ';
							echo form_dropdown('id_subbidang', $subbidang, $subbidang_selected, $dd_subbidang);
							?>	
						</div>
					 </div>
					 <div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12">LEVEL</label>
							<div class="col-md-7 col-xs-12" >
							<?php 
							$dd_level = 'class="form-control" ';
							echo form_dropdown('id_level', $level, $level_selected, $dd_level);
							?>	
						</div>
					 </div>
					  <div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12">GOLONGAN</label>
							<div class="col-md-7 col-xs-12" >
							<?php 
							$dd_golongan = 'class="form-control" ';
							echo form_dropdown('id_golongan', $golongan, $golongan_selected, $dd_golongan);
							?>	
						</div>
					 </div>
					  <div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12">JABATAN</label>
							<div class="col-md-7 col-xs-12" >
							<?php 
							$dd_jabatan = 'class="form-control" ';
							echo form_dropdown('id_jabatan', $jabatan, $jabatan_selected, $dd_jabatan);
							?>	
						</div>
					 </div>
