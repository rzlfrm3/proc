            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url()."index.php/admin/bidang/do_update"; ?>">
                      ...
                      <div class="item form-group">
                        ...
                        <input type="number" id="number" name="id_bidang" required="required"  class="form-control col-md-7 col-xs-12" value="<?php echo $id_bidang; ?>" readonly>
                        </div>
                      </div>
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="nama_bidang" required="required" type="text" value="<?php echo $nama_bidang; ?>">
                        </div>
                      </div>
					   <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">KEPALA BIDANG</label>
								<div class="col-md-7 col-xs-12" >
								<?php 
								$dd_kepalabidang = 'class="form-control" ';
								echo form_dropdown('id_kepalabidang', $kepalabidang, $kepalabidang_selected, $dd_kepalabidang);
								?>	
								</div>
						 </div>
