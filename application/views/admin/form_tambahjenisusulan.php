              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url()."index.php/admin/jenisusulan/do_insert"; ?>">
                      ...
                      <div class="item form-group">
                        ...
                        <input type="number" id="number" name="id_jenisusulan" required="required"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="nama_jenisusulan" required="required" type="text">
                        </div>
                      </div>
