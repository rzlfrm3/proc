                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
					  ...
					  <tr>
					  <td><?php echo $d['id_kepalabidang']; ?></td>
					  <td><?php echo $d['nama_kepalabidang']; ?></td>
					  <td align="center">
					  <a href="<?php echo base_url()."index.php/admin/kepalabidang/edit_data/".$d['id_kepalabidang']; ?>"><button class="btn">Edit</button></a> 
					  <a href="<?php echo base_url()."index.php/admin/kepalabidang/do_delete/".$d['id_kepalabidang']; ?>"><button class="btn btn-primary waves-effect">Delete</button></a>
					  </tr>
					  <?php } ?>
                    </table>
                  </div>
				  <a href="<?php echo base_url()."index.php/admin/kepalabidang/add_data"; ?>"><button class="btn btn-success">Tambah data</button></a>
                </div>
              </div>
        <!-- /page content -->
