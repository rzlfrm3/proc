              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url()."index.php/admin/jenisusulan/do_update"; ?>">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">ID JENIS USULAN<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="number" id="number" name="id_jenisusulan" required="required"  class="form-control col-md-7 col-xs-12" value="<?php echo $id_jenisusulan; ?>" readonly>
                        </div>
                      </div>
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">NAMA JENIS USULAN<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="nama_jenisusulan" required="required" type="text" value="<?php echo $nama_jenisusulan; ?>">
                        </div>
                      </div>
