              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-table"></i> Tables <span class="fa fa-chevron-down"></span></a>
				   ...
				   <li><a><i class="fa fa-desktop"></i> Metode WP <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url()."index.php/admin/alternatif/index/"; ?>">Table ALternatif</a></li>
					  <li><a href="<?php echo base_url()."index.php/admin/kriteria/index/"; ?>">Table Kriteria</a></li>
					  <li><a href="<?php echo base_url()."index.php/admin/nilai/index/"; ?>">Table Nilai</a></li>
					  <li><a href="<?php echo base_url()."index.php/admin/bobot/index/"; ?>">Table Bobot</a></li>
					  <li><a href="<?php echo base_url()."index.php/admin/rangking/index/"; ?>">Table Rangking</a></li>
					  <li><a href="<?php echo base_url()."index.php/admin/vektor_s/index/"; ?>">Table Vektor S</a></li>
					  <li><a href="<?php echo base_url()."index.php/admin/vektor_v/index/"; ?>">Table Vektor V</a></li>
                    </ul>
                  </li>
				   <li><a><i class="fa fa-bar-chart-o"></i> Data Presentation <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
					<li><a href="<?php echo base_url()."index.php/admin/graph"; ?>">Grafik</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
