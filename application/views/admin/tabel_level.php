                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
					  ...
					  <td align="center">
					  <a href="<?php echo base_url()."index.php/admin/level/edit_data/".$d['id_level']; ?>"><button class="btn">Edit</button></a> 
					  <a href="<?php echo base_url()."index.php/admin/level/do_delete/".$d['id_level']; ?>"><button class="btn btn-primary waves-effect">Delete</button></a>
					  </tr>
					  <?php } ?>
                    </table>
                  </div>
				  <a href="<?php echo base_url()."index.php/admin/level/add_data"; ?>"><button class="btn btn-success">Tambah data</button></a>
                </div>
              </div>
        <!-- /page content -->
