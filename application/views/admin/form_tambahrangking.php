            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url()."index.php/admin/rangking/do_insert"; ?>">
					  ...
					  <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">ALTERNATIF</label>
								<div class="col-md-7 col-xs-12" >
								<?php 
								$dd_alternatif = 'class="form-control" ';
								echo form_dropdown('id_alternatif', $alternatif, $alternatif_selected, $dd_alternatif);
								?>	
								</div>
						 </div>
						  <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">BOBOT</label>
								<div class="col-md-7 col-xs-12" >
								<?php 
								$dd_bobot = 'class="form-control" ';
								echo form_dropdown('id_kriteria', $bobot, $bobot_selected, $dd_bobot);
								?>	
								</div>
						 </div>
						<div class="item form-group">
							...
							<input type="number" id="number" name="nilai_rangking" required="required"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  ...
					  <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">BOBOT</label>
								...
								<?php 
								$dd_bobot = 'class="form-control" ';
								echo form_dropdown('id_kriteria2', $bobot, $bobot_selected, $dd_bobot);
								?>	
								</div>
						 </div>
						<div class="item form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">NILAI 2<span class="required">*</span>
							</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="number" id="number" name="nilai_rangking2" required="required"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					   ...
					   <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">BOBOT</label>
								...
								<?php 
								$dd_bobot = 'class="form-control" ';
								echo form_dropdown('id_kriteria3', $bobot, $bobot_selected, $dd_bobot);
								?>	
								</div>
						 </div>
						<div class="item form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">NILAI 3<span class="required">*</span>
							</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="number" id="number" name="nilai_rangking3" required="required"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					   ...
					   <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">BOBOT</label>
								...
								<?php 
								$dd_bobot = 'class="form-control" ';
								echo form_dropdown('id_kriteria4', $bobot, $bobot_selected, $dd_bobot);
								?>	
								</div>
						 </div>
						<div class="item form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">NILAI 4<span class="required">*</span>
							</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="number" id="number" name="nilai_rangking4" required="required"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					    ...
					    <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">BOBOT </label>
								...
								<?php 
								$dd_bobot = 'class="form-control" ';
								echo form_dropdown('id_kriteria5', $bobot, $bobot_selected, $dd_bobot);
								?>	
								</div>
						 </div>
						<div class="item form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">NILAI 5<span class="required">*</span>
							</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="number" id="number" name="nilai_rangking5" required="required"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
