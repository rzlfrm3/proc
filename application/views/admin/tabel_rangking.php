                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
					  ...
					  <tr>
					  <td><?php echo $d->id_rangking; ?></td>
					  <td><?php echo $d->nama_alternatif; ?></td>
					  <td><?php echo $d->nilai_normalisasi; ?></td>
					  <td><?php echo $d->nilai_normalisasi2; ?></td>
					  <td><?php echo $d->nilai_normalisasi3; ?></td>
					  <td><?php echo $d->nilai_normalisasi4; ?></td>
					  <td><?php echo $d->nilai_normalisasi5; ?></td>
					  <td align="center">
					  <a href="<?php echo base_url()."index.php/admin/rangking/edit_data/".$d->id_rangking; ?>"><button class="btn">Hitung Vektor S</button></a> 
					  </tr>
					  <?php } ?>
                    </table>
                  </div>
				  <a href="<?php echo base_url()."index.php/admin/rangking/add_data"; ?>"><button class="btn btn-success">Tambah data</button></a>
                </div>
              </div>
        <!-- /page content -->
