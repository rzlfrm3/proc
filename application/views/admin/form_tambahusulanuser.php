            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url()."index.php/admin/usulanuser/do_insert"; ?>">
					  ...
					  <div class="form-group">
						 ...
						 <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">PEJABAT PENGADAAN</label>
								<div class="col-md-7 col-xs-12">
									<select class="form-control" name="id_pejabatpengadaan">
										<option></option>
										<option value="199545">Belum Ada</option>
