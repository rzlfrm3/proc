                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
					  ...
					  <td align="center">
					  <a href="<?php echo base_url()."index.php/admin/bidang/edit_data/".$d->id_bidang; ?>"><button class="btn">Edit</button></a> 
					  <a href="<?php echo base_url()."index.php/admin/bidang/do_delete/".$d->id_bidang; ?>"><button class="btn btn-primary waves-effect">Delete</button></a>
					  </tr>
					  <?php } ?>
                    </table>
                  </div>
				  <a href="<?php echo base_url()."index.php/admin/bidang/add_data"; ?>"><button class="btn btn-success">Tambah data</button></a>
                </div>
              </div>
        <!-- /page content -->
