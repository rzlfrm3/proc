                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th>ID JENIS USULAN</th>
                          <th>NAMA JENIS USULAN</th>
						  <th>ACTION</th>
                        </tr>
                      </thead>
					  ...
					  <tr>
					  <td><?php echo $d['id_jenisusulan']; ?></td>
					  <td><?php echo $d['nama_jenisusulan']; ?></td>
					  <td align="center">
					  <a href="<?php echo base_url()."index.php/admin/jenisusulan/edit_data/".$d['id_jenisusulan']; ?>"><button class="btn">Edit</button></a> 
					  <a href="<?php echo base_url()."index.php/admin/jenisusulan/do_delete/".$d['id_jenisusulan']; ?>"><button class="btn btn-primary waves-effect">Delete</button></a>
					  </tr>
					  <?php } ?>
                    </table>
                  </div>
				  <a href="<?php echo base_url()."index.php/admin/jenisusulan/add_data"; ?>"><button class="btn btn-success">Tambah data</button></a>
                </div>
              </div>
        <!-- /page content -->
