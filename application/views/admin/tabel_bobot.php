                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
					  ...
					  <td><?php echo $d->jum_nilai; ?></td>
					   <td align="center">
					  <a href="<?php echo base_url()."index.php/admin/bobot/do_delete/".$d->id_kriteria; ?>"><button class="btn btn-primary waves-effect">Delete</button></a>
					  </tr>
					  <?php 
					  $jumlah_bobot = $jumlah_bobot + $d->nilai_bobot;
					  $jum_nilai = $jum_nilai + $d->jum_nilai;
					  } ?>
					   <tfoot>
                                  <tr>
									<td>Total Nilai Bobot : </td>
                                    <td><?php echo $jumlah_bobot; ?></td>
									<td><?php echo $jum_nilai; ?></td>
									<td></td>
                                  </tr>
                                </tfoot>
                    </table>
                  </div>
				  <a href="<?php echo base_url()."index.php/admin/bobot/add_data"; ?>"><button class="btn btn-success">Tambah data</button></a>
                </div>
              </div>
        <!-- /page content -->
