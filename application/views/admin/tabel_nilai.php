            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<!--	  <td><?php echo $d['id_nilai']; ?></td> -->
					  <td><?php echo $d['ket_nilai']; ?></td>
					  <td><?php echo $d['jum_nilai']; ?></td>
					  <td align="center">
					  <a href="<?php echo base_url()."index.php/admin/nilai/edit_data/".$d['id_nilai']; ?>"><button class="btn">Edit</button></a> 
					  <a href="<?php echo base_url()."index.php/admin/nilai/do_delete/".$d['id_nilai']; ?>"><button class="btn btn-primary waves-effect">Delete</button></a>
					 
					  </tr>
					  <?php } ?>
                    </table>
                  </div>
				  <a href="<?php echo base_url()."index.php/admin/nilai/add_data"; ?>"><button class="btn btn-success">Tambah data</button></a>
                </div>
              </div>
        <!-- /page content -->
