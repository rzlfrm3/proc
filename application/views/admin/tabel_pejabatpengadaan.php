                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th>ID PEJABAT PENGADAAN</th>
                          <th>NAMA PEJABAT PENGADAAN</th>
						  <th>ACTION</th>
                        </tr>
                      </thead>
					  ...
					  <tr>
					  <td><?php echo $d['id_pejabatpengadaan']; ?></td>
					  <td><?php echo $d['nama_pejabatpengadaan']; ?></td>
					  <td align="center">
					  <a href="<?php echo base_url()."index.php/admin/pejabatpengadaan/edit_data/".$d['id_pejabatpengadaan']; ?>"><button class="btn">Edit</button></a> 
					  <a href="<?php echo base_url()."index.php/admin/pejabatpengadaan/do_delete/".$d['id_pejabatpengadaan']; ?>"><button class="btn btn-primary waves-effect">Delete</button></a>
					  </tr>
					  <?php } ?>
                    </table>
                  </div>
				  <a href="<?php echo base_url()."index.php/admin/pejabatpengadaan/add_data"; ?>"><button class="btn btn-success">Tambah data</button></a>
                </div>
              </div>
        <!-- /page content -->
