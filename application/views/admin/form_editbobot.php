...
<html lang="en">
  <head>
    ...
    <title>Gentelella Alela! | </title> hgjgjhgjhgjgjhg gjhgjhg gjhgjh jgjg jgjhg
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url()."index.php/admin/bobot/do_insert"; ?>">
					  ...
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">KRITERIA<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="id_kriteria" value="<?php echo $id_kriteria; ?>" required="required" type="text" readonly>
                        </div>
                      </div> 
						  <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">BOBOT</label>
								...
								<?php 
								$dd_nilai = 'class="form-control" ';
								echo form_dropdown('nilai_bobot', $nilai, $nilai_selected, $dd_nilai);
								?>	
								</div>
						  </div>
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">TOTAL BOBOT<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="hasil_bobot" value="<?php echo $hasil_bobot; ?>" required="required" type="text" readonly>
                        </div>
                      </div> 
					<!--	<div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">ID BIDANG<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="number" id="number" name="jum_nilai" required="required"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div> -->
